...
-(NSMutableArray<UIImage *> *)customUnselectedImgMutArr{
    if (!_customUnselectedImgMutArr) {
        ...
        [_customUnselectedImgMutArr addObject:KBuddleIMG(@"bundle",@"Others",nil, @"Home")];
        [_customUnselectedImgMutArr addObject:KBuddleIMG(@"bundle",@"Others",nil,@"MyStore")];
        [_customUnselectedImgMutArr addObject:KBuddleIMG(@"bundle",@"Others",nil,@"摄像机")];
        [_customUnselectedImgMutArr addObject:KBuddleIMG(@"bundle",@"Others",nil, @"ShoppingCart")];
        [_customUnselectedImgMutArr addObject:KBuddleIMG(@"bundle",@"Others",nil, @"My")];
...
-(NSMutableArray<UIImage *> *)customSelectedImgMutArr{
    if (!_customSelectedImgMutArr) {
        ...
        [_customSelectedImgMutArr addObject:KBuddleIMG(@"bundle",@"Others",nil,@"Home")];
        [_customSelectedImgMutArr addObject:KBuddleIMG(@"bundle",@"Others",nil, @"MyStore")];
        [_customSelectedImgMutArr addObject:KBuddleIMG(@"bundle",@"Others",nil, @"摄像机")];
        [_customSelectedImgMutArr addObject:KBuddleIMG(@"bundle",@"Others",nil,@"ShoppingCart")];
        [_customSelectedImgMutArr addObject:KBuddleIMG(@"bundle",@"Others",nil, @"My")];
